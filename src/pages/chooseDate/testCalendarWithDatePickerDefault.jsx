          ...
          <ul>
            {dates.map((date, index) => {
              ...
              const matchedItemsc = freeSlot.filter(item =>
                console.log(new Date(new Date(item.time).getTime() + new Date(item.time).getTimezoneOffset() * 60000).getTime()),
                console.log(new Date(new Date(parseUkrainianDate(date))).getTime()),
